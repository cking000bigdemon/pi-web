      ...
      <div style={{ maxWidth: 820, margin: "0 auto" }}>
        ...
        {retryInfo && (
          <div style={{
            ...
            borderRadius: 0, fontSize: 12, color: "rgba(180,130,0,0.9)",
              ...
              {onSteer && (
                <button
                  ...
                  style={{
                    ...
                    padding: "7px 12px",
                    background: canQueueStreamingMessage ? "#F0A30A" : "var(--bg-panel)",
                    border: "1px solid var(--border)",
                    borderRadius: 0,
                    color: canQueueStreamingMessage ? "#1a1a1a" : "var(--text-dim)",
              ...
              {onFollowUp && (
                <button
                  ...
                  style={{
                    display: "flex", alignItems: "center", gap: 5,
                    padding: "7px 12px",
                    background: canQueueStreamingMessage ? "#647687" : "var(--bg-panel)",
                    border: "1px solid var(--border)",
                    borderRadius: 0,
                    color: canQueueStreamingMessage ? "#fff" : "var(--text-dim)",
                    cursor: canQueueStreamingMessage ? "pointer" : "not-allowed",
                    fontSize: 13, fontWeight: 600, letterSpacing: "-0.01em",
                    transition: "background 0.12s",
                  }}
              ...
              <div style={{ position: "relative" }}>
                {compactError && (
                  <div style={{
                    ...
                    fontSize: 11, padding: "4px 8px", borderRadius: 0,
